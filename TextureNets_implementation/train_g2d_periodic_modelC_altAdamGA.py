...
# the LOSS is wgan moment matching loss, 
# with alt Adam + riemmanian gradient ascent optimizer
...
outdir = './ckpt/' + args.dataname + '_g2d_modelC_altAdamGA'
mkdir(outdir)
...
def save_states():
    ...
    # copy code
    copyfile('./train_g2d_periodic_modelC_altAdamGA.py', outdir + '/code.txt')
...
#     paramsG.append(pa)
optimizerG = optim.Adam(netG.parameters(), lr=ETA_G)
